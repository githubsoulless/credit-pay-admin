...
<body onload="init()">
	<form action="${ctx }/guide/add" id="subForm" method="post" enctype="multipart/form-data" 
		target="hidden_frame">
		<input type="hidden" name="type" id="type" value="add">
		<div class="begin">
			<table border="" cellspacing="" cellpadding="">
				<tr>
					<td class="width90"><span style="color:red;">*</span><span>指南标题：</span></td>
					<td><span><input name="title" id="title" maxlength="10" class="ipt"/>
					</span></td>
				</tr>
				<tr>
				...
				<tr style="height: 80px;width: 730px">
					<td class="width90"><span style="color:red;">*</span><span>指南详情：</span></td>
					<td><span>
