...
public class ChroneApi {
	...
	public static Map<String, String> agentPayByAllinpayV2(FastOrder order,String orgId, String privateKey) {
		...
		try {
			...
			logger.info("--------------->agentPayByAllinpayV2 recv:"+httpRes.getRspStr());
	...
	public static Map<String, String> agentPayByTenfutong(FastOrder order,String orgId, String privateKey) {
		...
		try {
			...
			HttpResponse httpRes = HttpClientHelper.doHttp(ConfigReader.getConfig("chroneAgentPayUrl"),
					HttpClientHelper.POST,headers, "UTF-8", JSON.toJSONString(map), "180000");
			logger.info("--------------->agentPayByTenfutong recv:"+httpRes.getRspStr());
			if (StringUtils.isNotEmpty(httpRes.getRspStr())) {
				return JSON.parseObject(httpRes.getRspStr(), new TypeReference<HashMap<String, String>>() {
				});
			}
...
public static Map<String, String> agentPayByJiFuPay(FastOrder order,String orgId, String privateKey) {
		...
		try {
			...
			HttpResponse httpRes = HttpClientHelper.doHttp(ConfigReader.getConfig("chroneAgentPayUrl"),
					HttpClientHelper.POST,headers, "UTF-8", JSON.toJSONString(map), "180000");
			logger.info("--------------->agentPayByJiFuPay recv:"+httpRes.getRspStr());
			if (StringUtils.isNotEmpty(httpRes.getRspStr())) {
				return JSON.parseObject(httpRes.getRspStr(), new TypeReference<HashMap<String, String>>() {
				});
			}
