...
<body>
	<div class="page-content">
		<div class="page-header">
			<div class="row">
				<form action="${ctx}/accountDetail/list"  id="searchForm"   name="searchForm" method="post" class="form-inline" role="form">
					<div class="form-group">&nbsp;&nbsp;
						<label class="control-label" for="userId">用户账号：</label>
						<input  class="input-sm" type="text" id="userId"  name="userId" maxlength="20"  value="${accountDetail.userId}" /> 
					</div>
					<div class="form-group">&nbsp;&nbsp;
						<label class="control-label" for="accountName">真实姓名：</label>
						<input  class="input-sm" type="text" id="accountName"  name="accountName" maxlength="20"  value="${accountDetail.accountName}" /> 
					</div>
					<div class="form-group">&nbsp;&nbsp;
...
<form id="pageForm" action="${ctx }/accountDetail/list"  method="post" >
	<input type="hidden"  name="start" id="start"></input>
	<input type="hidden"  name="userId" value="${accountDetail.userId}"></input>
	<input type="hidden"  name="accountName" value="${accountDetail.accountName}"></input>
