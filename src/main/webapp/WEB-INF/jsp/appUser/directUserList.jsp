...
<body onload="init()">
	<div class="page-content">
		<div class="page-header">
			<div class="row">
				<form action="${ctx}/appUser/directUserList"  id="searchForm"   name="searchForm" method="post" class="form-inline" role="form">
					<div style="margin-left:12px;">
						<div class="form-group">
							<label class="control-label" for="userId">账号</label>
							<span>(${appuser.parentUserId})的直接下级用户列表</span> 
						</div>
					</div>
...
<form id="pageForm" action="${ctx }/appUser/directUserList"  method="post" >
